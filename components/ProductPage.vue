...
<template>
  <div class="flex flex-col items-center p-2 group/item">
    <div
      class="w-100% h-100% overflow-hidden bg-white shadow-[0px_4px_16px_rgba(0,0,0,0.05)] rounded-lg hover:cursor-pointer"
      :data-cat="product.category"
    >
      <div class="flex flex-col group/edit invisible group-hover/item:visible">
    ...
    <div class="flex flex-col items-center cursor-pointer">
      ...
      <div class="font-bold text-sm pl-2 pr-2 p-[4px]">{{ product.price }} ₽</div>
    </div>
  </div>
</template>
